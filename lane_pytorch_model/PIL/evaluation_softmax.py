...
parser.add_argument('--model_path', dest='model_path', default='/mnt/lustre/dingmingyu/workspace/Pytorch/checkpoints_size/023_checkpoint.pth.tar',
...
def main():
    ...
    for line in f:
        ...
        prob = output.data.cpu().numpy()#.transpose(1,0)
        #prob.transpose((1,0))
        gtlb = np.array(gtlb.resize((prob.shape[2], prob.shape[1]),Image.ANTIALIAS))
        #print gtlb.shape
