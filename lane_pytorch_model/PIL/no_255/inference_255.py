...
parser.add_argument('--model_path', dest='model_path', default='/mnt/lustre/dingmingyu/workspace/Pytorch/checkpoints_16_new/016_checkpoint.pth.tar',
...
def main():
    ...
    for line in f:
        ...
        image = image.resize((257,225),Image.ANTIALIAS)
       ...
       # probAll = cv2.resize(probAll, (224,192), interpolation = cv2.INTER_NEAREST)
        test_img = cv2.resize(test_img, (257,225))
