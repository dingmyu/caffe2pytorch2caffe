...
from loss import *
from dataloader_no_trans import *
import lanenet_16
import os
...
parser.add_argument('--new_length', default=225, type=int)
parser.add_argument('--new_width', default=257, type=int)
parser.add_argument('--label_length', default=225, type=int)
parser.add_argument('--label_width', default=257, type=int)
...
parser.add_argument('--resume', default='checkpoints_16_new', type=str, metavar='PATH',
